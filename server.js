...
const port = args.port || process.env.PORT || 3000 // if defined => use args, if not defined => use env variable, else use 3000
...
fs.readFile('./www/index.html', 'utf8', (err, data) => { // input read into "data"
    if (err) {
        console.error(err)
        return
        process.exit(1)
